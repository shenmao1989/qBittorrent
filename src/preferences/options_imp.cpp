...
QString options_imp::languageToLocalizedString(QLocale::Language language, const QString& country)
{
  ...
  case QLocale::Turkish: return QString::fromUtf8("Türk?e");
  case QLocale::Greek: return QString::fromUtf8("Ελληνικ?");
  ...
  case QLocale::Ukrainian: return QString::fromUtf8("Укра?нська");
