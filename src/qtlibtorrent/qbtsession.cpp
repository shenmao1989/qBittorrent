    ...
    m_upnp(0), m_natpmp(0), m_dynDNSUpdater(0)
{
  ...
  // Construct session
  s = new session(fingerprint(peer_id.toLocal8Bit().constData(), 1, 8, 2, 0), 0);
  ...
  addConsoleMessage("Peer ID: "+misc::toQString(fingerprint(peer_id.toLocal8Bit().constData(), 1, 8, 2, 0).to_string()));
